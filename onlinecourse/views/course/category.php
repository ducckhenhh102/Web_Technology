...
<div class="bg-primary text-white py-5 mb-5">
    <div class="container text-center">
        <h1 class="fw-bold"><?= htmlspecialchars($categoryName ?? 'Danh mục khóa học') ?></h1>
        <p class="lead mb-0">Các khóa học chất lượng thuộc chủ đề này đang chờ đón bạn</p>
    </div>
</div>
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-6">
            <h4 class="fw-bold text-secondary">
                <i class="bi bi-grid-fill me-2"></i><?= htmlspecialchars($categoryName ?? 'Danh sách') ?>
            </h4>
        </div>
        <div class="col-md-6">
            <form action="index.php" method="GET" class="d-flex">
                ...
                <input type="text" name="keyword" class="form-control me-2 rounded-pill" placeholder="Tìm kiếm khóa học...">
    ...
    <div class="row">
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="mb-2">
                                <span class="badge bg-light text-primary border border-primary-subtle rounded-pill">
                                    <?= htmlspecialchars($course['category_name'] ?? $categoryName ?? 'Khóa học') ?>
                                </span>
                            </div>
        ...
        <?php else: ?>
            <div class="col-12 text-center py-5">
                ...
                <h5 class="text-muted">Chưa có khóa học nào trong danh mục này.</h5>
                <a href="index.php?controller=course&action=list" class="btn btn-primary mt-3 rounded-pill px-4">Xem tất cả khóa học</a>
            </div>
        <?php endif; ?>
    </div>
